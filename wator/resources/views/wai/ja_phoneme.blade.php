  ...
  <div class="card-body">
    ...
    <div class="row">
      <div class="col  m-0 p-0">
        <button type="submit" class="btn btn-lg btn-outline-dark rounded-circle" style="height=96;">
          <i class="material-icons " style="font-size:24px;color:green;">hearing</i>
        </button>
      </div>
      <div class="col  m-0 p-0">
        <button type="submit" class="btn btn-lg btn-outline-dark rounded-circle" style="height=96;" onclick="onClickRecordBtn(this)">
