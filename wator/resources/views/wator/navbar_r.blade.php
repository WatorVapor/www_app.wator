<?php
  ...
  $langs .= '</a>';
  $langs .= '<a class="btn btn-success mr-lg-5" onclick="onClickLanguage(\'ja\')" role="button">';
  ...
  $langs .= '</a>';
  $langs .= '<a class="btn btn-success mr-lg-5" onclick="onClickLanguage(\'ru\')" role="button">';
...
<?php
  ...
  $apps .= '</a>';
  $apps .= '<a class="btn btn-lg btn-success mr-lg-5" href="/story" role="button">';
