<div class="row mt-lg-5 justify-content-center">
  <div class="col-5">
    <div class="card card-default text-center bg-secondary">
      ...
      <div class="card-body">
        <pre class="card-text text-success" id="text-this-device-key" style="white-space: pre-wrap ; font-size: large;">
          @{{ pub_key }}
        </pre>
        <br/>
  ...
  <div class="col-5">
    <div class="card card-default text-center bg-info">
      ...
      <div class="card-body">
        <textarea class="form-control input-sm" id="text-remote-device-key" rows="11" ></textarea>
        <br/>
