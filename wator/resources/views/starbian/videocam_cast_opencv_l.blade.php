...
<script src="/wator/starbian/js/starbian.js?v={{ time() }}" type="text/javascript"></script>
<script src="/wator/starbian/js/starbian_rtc.js?v={{ time() }}" type="text/javascript"></script>


@include('starbian.js.videocam_cast_cv')
@include('starbian.js.m_localstorage')
@include('starbian.js.starbian_tts')
@include('starbian.js.starbian_l_storage')
