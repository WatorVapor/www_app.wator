...
class CloudVideocamController extends Controller
{
    ...
    public function index_cast_capture($remote = null)
    {
        if(isset($remote)) {
            return view('starbian.videocam_cast_capture',['remote'=>$remote]);
        } else {
            return view('starbian.videocam_cast_capture',['remote'=>'']);
        }
    }
    ...
    public function index_cast_opencv_l($remote = null)
    {
        if(isset($remote)) {
            return view('starbian.videocam_cast_opencv_l',['remote'=>$remote]);
        } else {
            return view('starbian.videocam_cast_opencv_l',['remote'=>'']);
        }
    }
